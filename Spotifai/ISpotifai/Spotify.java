...
public class Spotify {
	...
	// Radio
	public String tocarRadio (String genero) throws RadioNaoEncontradaException, NaoHaMusicasException {
		return this.radio.tocarRadio(genero);
	}
	...
	public Radio criarRadio (String genero, int i) throws NaoHaGeneroException {
		Radio radio = new Radio (genero, i);
		return this.radio.criarRadio(genero, musica.getRep(), i, radio);
	}
	//fim Radio
}
