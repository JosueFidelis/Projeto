...
public class Main {
	...
	public static void tocarRadio()
	{
		...
		try{System.out.println(spotify.tocarRadio(gender));
	...
	public static void criarRadio () {
		System.out.print("Digite o gênero da rádio que quer criar");
		String genero = in.nextLine();
		try {
			int i = 0;
			spotify.criarRadio(genero, i);
			System.out.println("Rádio criada com sucesso");
	...
	public static void removerRadio () {
		...
		try {
			...
			System.out.println("Radio removida com sucesso");
		} catch (RadioNaoEncontradaException e) {
			System.out.println(e.getMessage());
		} Start();
	}
